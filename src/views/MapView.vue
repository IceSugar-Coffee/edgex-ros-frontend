<template v-slot:dropdown>
    ...
    <div class="container">
        ...
        <div class="right">
            <p>Car1: cm/s</p>
            <chart1 deviceName="device1" />
            <chart2 deviceName="device2" />
            <chart3 deviceName="device2" />
        </div>
    </div>
    <!-- <div>
...
<script>
import chart1 from "../components/MyChart1.vue"
import chart2 from "../components/MyChart2.vue"
import chart3 from "../components/MyChart3.vue"
